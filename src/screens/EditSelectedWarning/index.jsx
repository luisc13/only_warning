...
export function EditSelectedWarning(){
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <TextInput placeholder="Título" placeholderColor="#c4c3cb" style={styles.titleInput} value={title} onChangeText={(e) => setTitle(e)}/>
      <TextInput placeholder="Conteúdo" placeholderColor="#c4c3cb" style={styles.contentInput} value={content} onChangeText={(e) => setContent(e)} />
